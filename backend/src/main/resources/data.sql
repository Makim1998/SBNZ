...
update user_table set klijent_id = 1 where id = 1;

insert into klijent_table (godine, mesecna_zarada, nagradni_poeni, stanje_racun, pridruzen) values (35, 1000, 0, 50000, '2018-10-10');
update user_table set klijent_id = 2 where id = 2;
